...
router.post('/addSecond', function(req, res, next) {
    const sql = $sql.second.addSecond;
...
router.post('/findSecondByPoint', function(req, res, next) {
    const sql = $sql.second.findSecondByPoint;
    const params = req.body;
...
router.post('/findSecondByLike', function(req, res, next) {
    const sql = $sql.second.findSecondByLike;
    const params = req.body;
